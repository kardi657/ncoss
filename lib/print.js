...
export default async function (m, conn = { user: {} }) {
  ...
  console.log(`
${chalk.white.bold('—————————————————————————————————————————————')}
${chalk.blue.bold('———————————————ISI PESAN———————————————')}
${chalk.white.bold('|')} ${chalk.redBright('» BOT NAME:')} ${chalk.green('%s')}
${chalk.white.bold('|')} ${chalk.redBright('» TANGGAL:')} ${chalk.green('%s')} ${chalk.green('%s')}
${chalk.white.bold('|')} ${chalk.redBright('» SIZE:')} ${chalk.green('%s [%s %sB]')}
${chalk.white.bold('|')} ${chalk.redBright('» USERNAME:')} ${chalk.green('%s')}
${chalk.white.bold('|')} ${chalk.redBright('» INFO:')} ${chalk.green('%s%s')}
${chalk.white.bold('|')} ${chalk.redBright('» TUJUAN:')} ${chalk.green('%s')}
${chalk.blue.bold('———————————————CHOSTHEA———————————————')}
${chalk.white.bold('—————————————————————————————————————————————')}
${chalk.red.bold(chalk.bgBlue('%s'))}
`.trim(),
    me + ' ~' + conn.user.name,
