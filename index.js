...
console.log(chalk.white(`  Instagram: ${chalk.cyan('https://instagram.com/encos_thea233')}`));
console.log(chalk.white(`  Facebook:  ${chalk.cyan('https://facebook.com/jajang.pascal')}`));
console.log(chalk.white(`  WhatsApp:  ${chalk.cyan('wa.me/628159994194')}`));
console.log(chalk.gray('-'.repeat(50)));
